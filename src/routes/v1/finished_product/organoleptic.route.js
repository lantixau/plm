...
const validation = require('../../../validations/finished_product/organoleptic.validation');
const controller = require('../../../controllers/finished_product/organoleptic.controller');

const router = express.Router();

const singularName = 'Finished Product Organoleptic';
const pluralName = 'Finished Product Organoleptics';
