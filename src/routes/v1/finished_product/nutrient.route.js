...
const validation = require('../../../validations/finished_product/nutrient.validation');
const controller = require('../../../controllers/finished_product/nutrient.controller');

const router = express.Router();

const singularName = 'Finished Product Nutrient';
const pluralName = 'Finished Product Nutrients';
