...
const validation = require('../../../validations/finished_product/composition.validation');
const controller = require('../../../controllers/finished_product/composition.controller');

const router = express.Router();

const singularName = 'Finished Product Composition';
const pluralName = 'Finished Product Composition';
