...
const validation = require('../../../validations/finished_product/label.validation');
const controller = require('../../../controllers/finished_product/label.controller');

const router = express.Router();

const singularName = 'Finished Product Label';
const pluralName = 'Finished Product Labels';
