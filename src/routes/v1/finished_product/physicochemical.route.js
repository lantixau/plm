...
const validation = require('../../../validations/finished_product/physicochemical.validation');
const controller = require('../../../controllers/finished_product/physicochemical.controller');

const router = express.Router();

const singularName = 'Finished Product Physicochemical';
const pluralName = 'Finished Product Physicochemicals';
