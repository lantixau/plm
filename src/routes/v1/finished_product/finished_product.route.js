...
const validation = require('../../../validations/finished_product/finished_product.validation');
const controller = require('../../../controllers/finished_product/finished_product.controller');

const router = express.Router();

const singularName = 'Finished Product';
const pluralName = 'Finished Products';
