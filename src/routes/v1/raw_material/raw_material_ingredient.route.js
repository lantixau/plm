...
const validation = require('../../../validations/raw_material/raw_material_ingredient.validation');
const controller = require('../../../controllers/raw_material/raw_material_ingredient.controller');

const router = express.Router();

const singularName = 'Raw Material Ingredient';
const pluralName = 'Raw Material Ingredients';
