...
const validation = require('../../../validations/raw_material/raw_material.validation');
const controller = require('../../../controllers/raw_material/raw_material.controller');

const router = express.Router();

const singularName = 'Raw Material';
const pluralName = 'Raw Materials';
