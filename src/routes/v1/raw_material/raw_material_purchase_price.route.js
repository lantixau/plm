...
const validation = require('../../../validations/raw_material/raw_material_purchase_price.validation');
const controller = require('../../../controllers/raw_material/raw_material_purchase_price.controller');

const router = express.Router();

const singularName = 'Raw Material Purchase Price';
const pluralName = 'Raw Material Purchase Prices';
...
router
  .route('/:rawMaterialPurchasePriceId')
