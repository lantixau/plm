...
const validation = require('../../../validations/raw_material/raw_material_physicochemical.validation');
const controller = require('../../../controllers/raw_material/raw_material_physicochemical.controller');

const router = express.Router();

const singularName = 'Raw Material Physicochemical';
const pluralName = 'Raw Material Physicochemicals';
...
router
  .route('/:rawMaterialPhysicochemicalId')
