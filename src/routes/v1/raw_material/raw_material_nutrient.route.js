...
const validation = require('../../../validations/raw_material/raw_material_nutrient.validation');
const controller = require('../../../controllers/raw_material/raw_material_nutrient.controller');

const router = express.Router();

const singularName = 'Raw Material Nutrient';
const pluralName = 'Raw Material Nutrients';
