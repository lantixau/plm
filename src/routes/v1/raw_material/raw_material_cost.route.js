...
const validation = require('../../../validations/raw_material/raw_material_cost.validation');
const controller = require('../../../controllers/raw_material/raw_material_cost.controller');

const router = express.Router();

const singularName = 'Raw Material Cost';
const pluralName = 'Raw Material Costs';
