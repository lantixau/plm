...
const validation = require('../../validations/general_setting.validation');
const controller = require('../../controllers/general_setting.controller');

const router = express.Router();

const singularName = 'General Setting';
const pluralName = 'General Settings';
