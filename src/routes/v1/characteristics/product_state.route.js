...
const validation = require('../../../validations/characteristics/product_state.validation');
const controller = require('../../../controllers/characteristics/product_state.controller');

const router = express.Router();

const singularName = 'Product State';
const pluralName = 'Product States';
