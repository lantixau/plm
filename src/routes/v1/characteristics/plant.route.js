...
const validation = require('../../../validations/characteristics/plant.validation');
const controller = require('../../../controllers/characteristics/plant.controller');

const router = express.Router();

const singularName = 'Plant';
const pluralName = 'Plants';
