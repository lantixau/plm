...
const validation = require('../../../validations/characteristics/precaution_of_use.validation');
const controller = require('../../../controllers/characteristics/precaution_of_use.controller');

const router = express.Router();

const singularName = 'Precaution Of Use';
const pluralName = 'Precaution Of Use';
