...
const validation = require('../../../validations/characteristics/biological_origin.validation');
const controller = require('../../../controllers/characteristics/biological_origin.controller');

const router = express.Router();

const singularName = 'Biological Origin';
const pluralName = 'Biological Origins';
