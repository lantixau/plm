...
const validation = require('../../../validations/characteristics/cost_type.validation');
const controller = require('../../../controllers/characteristics/cost_type.controller');

const router = express.Router();

const singularName = 'Cost Type';
const pluralName = 'Cost Types';
