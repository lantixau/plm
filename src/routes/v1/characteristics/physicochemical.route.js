...
const validation = require('../../../validations/characteristics/physicochemical.validation');
const controller = require('../../../controllers/characteristics/physicochemical.controller');

const router = express.Router();

const singularName = 'Physicochemical';
const pluralName = 'Physicochemicals';
