...
const validation = require('../../../validations/characteristics/microbiological.validation');
const controller = require('../../../controllers/characteristics/microbiological.controller');

const router = express.Router();

const singularName = 'Microbiological';
const pluralName = 'Microbiologicals';
