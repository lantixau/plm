...
const validation = require('../../../validations/characteristics/nutrient_method.validation');
const controller = require('../../../controllers/characteristics/nutrient_method.controller');
