...
const validation = require('../../../validations/characteristics/currency.validation');
const controller = require('../../../controllers/characteristics/currency.controller');

const router = express.Router();

const singularName = 'Currency';
const pluralName = 'Currencys';
