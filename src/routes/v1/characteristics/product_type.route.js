...
const validation = require('../../../validations/characteristics/product_type.validation');
const controller = require('../../../controllers/characteristics/product_type.controller');

const router = express.Router();

const singularName = 'Product Type';
const pluralName = 'Product Types';
