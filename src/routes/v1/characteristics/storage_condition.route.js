...
const validation = require('../../../validations/characteristics/storage_condition.validation');
const controller = require('../../../controllers/characteristics/storage_condition.controller');

const router = express.Router();

const singularName = 'Storage Condition';
const pluralName = 'Storage Conditions';
